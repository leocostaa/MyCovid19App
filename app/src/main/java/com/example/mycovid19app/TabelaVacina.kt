...
class TabelaVacina (db: SQLiteDatabase) {
    ...
    fun cria() {
        db.execSQL("CREATE TABLE  $NOME_TABELA (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $CAMPO_ORIGEM TEXT NOT NULL, $CAMPO_VALIDADE INTEGER NOT NULL, $CAMPO_QUANTIDADE INTEGER NOT NULL )")
